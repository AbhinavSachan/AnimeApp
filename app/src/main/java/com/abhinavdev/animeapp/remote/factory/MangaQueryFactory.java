...
package com.abhinavdev.animeapp.remote.factory;
...
import net.sandrohc.jikan.query.manga.MangaExternalQuery;
...
import net.sandrohc.jikan.query.manga.MangaRelationsQuery;
import net.sandrohc.jikan.query.manga.MangaReviewsQuery;
import net.sandrohc.jikan.query.manga.MangaSearchQuery;
import net.sandrohc.jikan.query.manga.MangaStatisticsQuery;
